...
(function (global) {
   ...
   * https://{user}.biz1.co.il/app/Chat.Conversations
   */
   ...
   * https://{user}.biz1.co.il/app/Chat.SingleConversations
   */
  ...
  async function ensureSocketIo() {
    ...
    // Load from API host only — local vendor copy is blocked by ZIP scanners (eval).
