(function (global) {
  ...
  function applyAppVersion() {
    var version = (global.APP_CONFIG && global.APP_CONFIG.APP_VERSION) || '';
    if (!version) return;
    document.querySelectorAll('#appVersion, [data-app-version]').forEach(function (el) {
  ...
  global.Ui = {
    ...
    applyAppVersion: applyAppVersion
  };
})(window);
