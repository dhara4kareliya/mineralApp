window.OrderI18n = (function _i18nSub1() {
  "use strict";
  ...
  function t(key, vars) {
    ...
    if (vars && typeof vars === "object") {
      Object.keys(vars).forEach(function _i18nSub2(k) {
  ...
  function applyDom() {
    document.querySelectorAll("[data-i18n]").forEach(function _i18nSub3(el) {
      el.textContent = t(el.getAttribute("data-i18n"));
    });
    document.querySelectorAll("[data-i18n-placeholder]").forEach(function _i18nSub4(el) {
      el.setAttribute("placeholder", t(el.getAttribute("data-i18n-placeholder")));
    });
    document.querySelectorAll("[data-i18n-aria]").forEach(function _i18nSub5(el) {
      el.setAttribute("aria-label", t(el.getAttribute("data-i18n-aria")));
    });
    document.querySelectorAll("[data-i18n-title]").forEach(function _i18nSub6(el) {
      el.setAttribute("title", t(el.getAttribute("data-i18n-title")));
    });
    document.title = t("pageTitle");
    document.querySelectorAll("[data-set-lang]").forEach(function _i18nSub7(btn) {
  ...
  function init(opts) {
    ...
    setLang(saved, opts);
    document.addEventListener("click", function _i18nSub8(ev) {
