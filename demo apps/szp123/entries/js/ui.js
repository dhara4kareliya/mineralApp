...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      allCustomersTitle: 'All customers',
      ...
      deleteSelectedConfirm: 'This cannot be undone. Delete {n} selected entries?',
      deleteOneTitle: 'Delete entry?',
      deleteOneText: 'This removes the row from the selected entry tab. This cannot be undone.',
    ...
    he: {
      ...
      deleteSelectedTitle: 'למחוק רשומות נבחרות?',
      deleteSelectedConfirm: 'לא ניתן לבטל פעולה זו. למחוק {n} רשומות נבחרות?',
      deleteOneTitle: 'למחוק רשומה?',
      deleteOneText: 'פעולה זו מסירה את השורה מהטאב שנבחר. לא ניתן לבטל.',
